...
#include "SJ_SinglePlayerHandComponent.generated.h"


UCLASS( ClassGroup=(Custom), meta=(BlueprintSpawnableComponent) )
class DEVOLYMPIC_API USJ_SinglePlayerHandComponent : public UActorComponent
{
	GENERATED_BODY()

public:	
	// Sets default values for this component's properties
	USJ_SinglePlayerHandComponent();
...
public:	
	...
	class ASJ_SinglePingPongPlayer* player;
