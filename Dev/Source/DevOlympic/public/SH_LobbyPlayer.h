...
public:	
	...
	// 위젯 상호작용 포인터
	UPROPERTY(EditAnywhere, Category = ButtonInteractions)
		class UWidgetInteractionComponent* widgetPointer;

	// 위젯 상호작용 포인터
	UPROPERTY(EditAnywhere, Category = ReplicateSetting)
		class USH_PlayerReplicateComponent* replicateComponent;
